...
export default function Footer() {
  ...
  return (
    <div className="footer relative z-40 mb-12 mt-12">
      ...
      >
        <span className="w-2/4 sm:w-1/4 text-center text-gray-500">
          © {new Date().getFullYear()} Hamza Shah
        </span>
        <div className="svg w-2/4 text-center flex items-center justify-center">
          ...
          >
            ...
            >
              <path
                d="M1042 4217 l-1034 -612 6 -285 c3 -157 9 -699 12 -1206 l6 -921 1030
              ...
              />
              <path
                d="M1327 3583 c-4 -3 -7 -292 -7 -642 l0 -635 38 36 c39 37 187 136 309
                        207 100 57 128 83 160 149 l28 57 0 415 0 415 -261 3 c-143 1 -263 -1 -267 -5z"
              />
              <path
                d="M2388 3313 c-3 -264 -5 -281 -26 -328 -44 -97 -94 -135 -547 -416
              ...
              />
              <path
                d="M2860 2632 c-55 -71 -176 -162 -417 -312 l-53 -32 0 -555 c0 -443 3
