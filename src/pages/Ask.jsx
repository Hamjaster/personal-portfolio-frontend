    ...
    <div className="bg-black text-white h-[100vh] relative">
      ...
      <div className="grid text-3xl md:text-5xl grid-cols-2 absolute bottom-0 right-0 left-0 top-64 grid-rows-3">
        <div
          ...
          className="color  group bg-red-600 w-full flex items-center justify-center"
        >
          <div className=" overflow-hidden z-40 translate-x-32 transition-all opacity-0 group-hover:opacity-100 group-hover:translate-x-0 font-semibold uppercase">
            Red
          </div>
        </div>
        <div
          onClick={() => setTheam("purple")}
          className="color group bg-purple-600 w-full flex items-center justify-center"
        >
          <div className=" overflow-hidden z-40 translate-x-32 transition-all opacity-0 group-hover:opacity-100 group-hover:translate-x-0 font-semibold uppercase">
            Purple
          </div>
        ...
        <div
          ...
          className="color group bg-green-600 w-full flex items-center justify-center"
        >
          <div className=" overflow-hidden z-40 translate-x-32 transition-all opacity-0 group-hover:opacity-100 group-hover:translate-x-0 font-semibold uppercase">
            Green
          </div>
        ...
        <div
          ...
          className="color group bg-blue-600 w-full flex items-center justify-center"
        >
          <div className=" overflow-hidden z-40 translate-x-32 transition-all opacity-0 group-hover:opacity-100 group-hover:translate-x-0 font-semibold uppercase">
            Blue
          </div>
        ...
        <div
          ...
          className="color group bg-pink-600 col-span-2 w-full flex items-center justify-center"
        >
          <div className=" overflow-hidden z-40 translate-x-32 transition-all opacity-0 group-hover:opacity-100 group-hover:translate-x-0 font-semibold uppercase">
            Pink
          </div>
